...
import { getHighlighter, getTheme, commonLangIds, commonLangAliases, otherLangIds } from 'shiki';
...
export class DoubleHighlighter {
    ...
    private constructor(private light: Highlighter, readonly lightBg: string, private dark: Highlighter, readonly darkBg: string) {
    }
    ...
    getStyles() {
        let styles = Array.from(this.reverseSchemes.values(), ([light, dark], i) => {
            return [
                `.hl-${i} { color: ${light}; }`,
