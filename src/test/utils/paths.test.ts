...
describe("Paths", () => {
  describe("createMinimatch", () => {
    ...
    it("Minimatch can match absolute paths expressions", () => {
      ...
      Assert(
        mms[3].match(absolutePath("/some/deep/arbitrary/path/leading/nowhere")),
    ...
    it("Minimatch can match relative to the project root", () => {
      ...
      Assert(
        mms[2].match(Path.resolve("no/dot/relative/some/sub/dir/path/test")),
      ...
      Assert(
        mms[4].match(Path.resolve(".dot/relative/some/sub/dir/path/test")),
