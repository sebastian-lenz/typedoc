...
export class MethodReflection extends ContainerReflection<SignatureReflection> {
  ...
  get overwrites(): MethodReflection | undefined {
    return this._overwrites
      ? (this.project?.getReflectionById(this._overwrites) as
          | MethodReflection
          | undefined)
      : undefined;
  }
  ...
  get inheritedFrom(): MethodReflection | undefined {
    return this._inheritedFrom
      ? (this.project?.getReflectionById(this._inheritedFrom) as
          | MethodReflection
          | undefined)
      : undefined;
  }
  ...
  get implementationOf(): MethodReflection | undefined {
    return this._implementationOf
      ? (this.project?.getReflectionById(this._implementationOf) as
          | MethodReflection
          | undefined)
      : undefined;
  }
...
export class SignatureReflection extends Reflection {
  ...
  serialize(
    ...
    init: BaseSerialized<SignatureReflection>
...
export interface SerializedSignatureReflection
  extends Serialized<
    SignatureReflection,
    "parameters" | "typeParameters" | "returnType"
  > {}
