...
export class ParameterReflection extends Reflection {
  ...
  serialize(
    ...
    init: BaseSerialized<ParameterReflection>
  ): SerializedParameterReflection {
...
export interface SerializedParameterReflection
  extends Serialized<ParameterReflection, "type" | "defaultValue"> {}
