...
export class IndexedAccessType extends Type {
    ...
    /** @inheritdoc */
    serialize(serializer: Serializer, init: BaseSerialized<IndexedAccessType>): SerializedIndexedAccessType {
        return {
            ...init,
...
export interface SerializedIndexedAccessType extends Serialized<IndexedAccessType, 'objectType' | 'indexType'> {
}
